...
const lancamentos = ref([
  ...
  { id: 2, data: '2025-01-06', descricao: 'Empréstimo Mercado Bom Preço', valor: 1813.00, tipo: 'saida', origem: 'Sistema (Borderô)' },
  ...
  { id: 5, data: '2025-01-07', descricao: 'Empréstimo Ricardo Souza', valor: 296.00, tipo: 'saida', origem: 'Sistema (Borderô)' },
