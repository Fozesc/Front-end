...
const cheques = ref([
  { id: 1, vencimento: '2022-10-02', cliente: 'Cris de Pereira', banco: 'Santander', emitente: 'Rodrigo Martins Alves', num_doc: '38', valor_liquido: 8538.08, juros: 1461.92, dt_operacao: '2021-09-12', status: 'Pago', destino: 'Sicoob Conta Mestra', dt_pagamento: '2022-10-02', observacao: 'Pgto via TED Confirmado' },
